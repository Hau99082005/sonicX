...
const dynamicMusic_1 = __importDefault(require("./router/dynamicMusic"));
...
app.use("/dynamic-music", dynamicMusic_1.default);
app.use("/api/dynamic", dynamicMusic_1.default);
