...
exports.resolveTimeOfDay = resolveTimeOfDay;
exports.resolveContextsFromInput = resolveContextsFromInput;
exports.computeMix = computeMix;
exports.buildDefaultContextRules = buildDefaultContextRules;
...
function resolveContextsFromInput(input) {
    const contexts = [];
    const weatherMap = {
        rain: "rain",
        storm: "rain",
    ...
    if (weatherMap[input.weather])
        contexts.push(weatherMap[input.weather]);
    if (activityMap[input.activity])
        contexts.push(activityMap[input.activity]);
    if (timeMap[timeOfDay])
        contexts.push(timeMap[timeOfDay]);
    if (contexts.length === 0)
        contexts.push("default");
    return [...new Set(contexts)];
}
function computeMix(contextRules, resolvedContexts) {
    var _a, _b;
    ...
    const tempoMultiplier = (_a = topRule === null || topRule === void 0 ? void 0 : topRule.tempoMultiplier) !== null && _a !== void 0 ? _a : 1.0;
    const ambientSoundUrl = (_b = matchedRules.find((r) => r.ambientSoundUrl)) === null || _b === void 0 ? void 0 : _b.ambientSoundUrl;
    return {
