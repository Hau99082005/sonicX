import { getAutoGeneratedPlaylist, getFllowersProfile, getPublicPlaylist, getPublicProfile, getPublicUploads, getRecommendByProfile, getUploads, updatedFollower } from "#/controllers/follower";
